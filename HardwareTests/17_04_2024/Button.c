/*
Filename    : HardwareTests/Button.c
Author      : Andrew Law
...
void setupModeSwitch(struct Button *butt)
{
	if(butt->port == 1)
	{
		P1DIR |= butt->pin;       								// Sets P1.x as input
		P1OUT |= butt->pin;      									// Selects pull down resistor on P1.x
		P1REN |= butt->pin;       								// Enables pull down resistor on P1.x
	}
	else if(butt->port == 2)
	{
		P2DIR |= butt->pin;       								// Sets P2.x as input
		P2OUT |= butt->pin;      									// Selects pull down resistor on P2.x
		P2REN |= butt->pin;       								// Enables pull down resistor on P2.x
	}
}
//==============================================================================
// End of File :  HardwareTests/Button.c
