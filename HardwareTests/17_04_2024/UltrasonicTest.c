...
Description : Script to test the ultrasonic sensor components
			...
			Either RADAR, LEFT or RIGHT ultrasonic can be tested
			...
			sensor is used, where RADAR = 0, LEFT = 1 and RIGHT = 2,
...
13-APR-2024 andrewwlaw9178 added ...
14-APR-2024 andrewwlaw9178 added ...
15-APR-2024 andrewwlaw9178 added ...
...
LEFT and RIGHT requires setupTimerScheduler and setupTimerRADAR
*/
...
// RADAR Ultrasonic information - Port 1
...
int main(void)
{
    ...
    ultraUsed = 0;                                                          // 0 = RADAR (P1.2), 1 = LEFT (P2.0), 2 = RIGHT (P2.1)
...
// Determines RADAR ultrasonic pulse duration and raises flag - using capture mode
