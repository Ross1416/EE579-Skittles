...
#define ULTRA_LEFT_ECHO     BIT1                                        // Located at P2.1
...
struct Ultrasonic ultraRight = {0, {0, 0}, 0, ULTRA_LEFT_TRIG, ULTRA_LEFT_ECHO, 2};
...
int main(void)
{
    ...
    // Setup device
    ultrasonicSetup(&ultraRight);                                        // Set up pin for the left ultrasonic
