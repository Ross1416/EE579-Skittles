...
// UltraLeft Reading control
unsigned int i;

// Hardware ports
#define ULTRA_LEFT_TRIG     BIT0                                        // Located at P2.2
#define ULTRA_LEFT_ECHO     BIT2                                        // Located at P2.0
...
unsigned int wallDistancesLeft[WALL_READINGS] = {[0 ... WALL_READINGS-1] = 2000};
