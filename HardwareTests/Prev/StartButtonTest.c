/*
Filename    : HardwareTests/StartButtonTest.c
Author      : Andrew Law
Project     : EE579 Skittles Knocking Over Project
Date        : 9/4/24
Description : Script to test the start button component

            When start stop button is pressed indicator LED toggles.

            When Port 1 interrupt is triggered by start stop button, flag
            is raised for button, which causes checkFlags() to start a
            debounce timer, which checkSchedule() raises debounce flag,
            which causes indicator LED to be toggled in checkFlags().
--------------------------------------------------------------------------------
Functions Present
--------------------------------------------------------------------------------
setupStartStop()
...
Change History
--------------------------------------------------------------------------------
09-APR-2024 andrewlaw9178 created to modularise the start button
...
//==============================================================================
// End of File :  HardwareTests/StartButtonTest.c
