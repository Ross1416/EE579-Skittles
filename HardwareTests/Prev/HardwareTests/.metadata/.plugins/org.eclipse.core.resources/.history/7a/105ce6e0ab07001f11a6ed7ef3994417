...
void sonarTest(int trig, int echo, int port)
{
    // Set SONAR ultrasonic info
    ultraSONAR.distance = 0;
    ultraSONAR.time[2] = {0, 0};
    ultraSONAR.timeNumber = 0;
    ultraSONAR.trigPin = trig;
    ultraSONAR.echoPin = echo;
    ultraSONAR.port = port;
...
void rightTest(int trig, int echo, int port)
{
    // Set RIGHT ultrasonic info
    ultraRight.distance = 0;
    ultraRight.time[2] = {0, 0};
    ultraRight.timeNumber = 0;
    ultraRight.trigPin = trig;
    ultraRight.echoPin = echo;
    ultraRight.port = port;
...
__interrupt void Timer0_A0_ISR(void)
{
    ...
    if(component >= 6 && component < 10) // Would need to have a global variable in here for this
    {
